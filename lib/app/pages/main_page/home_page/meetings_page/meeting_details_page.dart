...
import 'package:webinar/app/pages/main_page/home_page/meetings_page/agora_call_page.dart';
                            ...
                            Container(
                              ...
                              child: Wrap(
                                ...
                                children: [
                                  ...
                                  SingleCourseWidget.courseStatus(
                                    appText.amount,
                                    CurrencyUtils.calculator(double.tryParse(
                                            meeting?.amount ?? '0') ??
                                        0),
                                    AppAssets.walletSvg,
                                    width: (getSize().width * .5) - 42,
                        ...
                        if ((details?.meeting?.meetingType ?? '') !=
                          ...
                          Expanded(
                            child: button(
                                onTap: () async {
                                  print('object');
                                  // Багш, сурагч хоёр ижил channelId ашиглах ёстой
                                  final channelId =
                                      'meeting_${details!.meeting!.id}';
                                  final uid = isConsultant
                                      ? 1
                                      : 2; // 1 = багш, 2 = сурагч
