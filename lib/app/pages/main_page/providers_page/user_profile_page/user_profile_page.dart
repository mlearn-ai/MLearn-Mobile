  ...
  getData(int id) async {
    ...
    if (profile?.roleName == 'organization') {
      tabController = TabController(
          length: (profile?.meetingStatus == 'no') ? 4 : 5, vsync: this);
    } else {
      tabController = TabController(
          length: (profile?.meetingStatus == 'no') ? 3 : 4, vsync: this);
    }
                ...
                Positioned.fill(
                    child: NestedScrollView(
                                  ...
                                  child: tabBar((i) {
                                    onChangeTab(i);
                                      ...
                                      [
                                        ...
                                        Tab(
                                          height: 32,
                                          child: Text(appText.classes),
                                        ),
                                        Tab(
                                          height: 32,
                                          child: Text(appText.badges),
                                        ),
                                        if ((profile?.meetingStatus !=
                                            'no')) ...{
                                          Tab(
                                            height: 32,
                                            child: Text(appText.meeting),
                                          ),
                                        },
                                        if (profile?.roleName ==
                                            'organization') ...{
                                          Tab(
                                            height: 32,
                                            child: Text(appText.instrcutors),
                                          ),
                                        }
                                      ],
                        ...
                        body: TabBarView(
                            ...
                            children: [
                              UserProfileWidget.aboutPage(
                                  profile ?? ProfileModel()),
                              UserProfileWidget.classesPage(
                                  profile ?? ProfileModel()),
                              UserProfileWidget.badgesPage(
                                  profile ?? ProfileModel()),
                              if ((profile?.meetingStatus != 'no')) ...{
                                UserProfileWidget.meetingPage(
                                    profile ?? ProfileModel()),
                              },
                              if (profile?.roleName == 'organization') ...{
                                UserProfileWidget.instructorPage(
                                  profile ?? ProfileModel(),
                                ),
                              }
                            ]))),
                      ...
                      children: [
                        Expanded(
                            child: button(
                                ...
                                width: getSize().width,
                                height: 51,
                                // text: (profile?.authUserIsFollower ?? false)
                                //     ? appText.unFollow
                                //     : appText.follow,comment
                      ...
                      children: [
                        ...
                        button(
                            onTap: () {
                              baseBottomSheet(
                                  child:
                                      SelectDatePage(profile!.id!, profile!));
                            },
                            width: getSize().width,
                            height: 51,
                            text: appText.reserveMeeting,
